...
{"byteSwap", (funct_t) byteSwap, (funct_t) test_byteSwap, 3,
    ...
    {{TMin, TMax},{0,3},{0,3}}},
    {"removeRightmostOne",
    (funct_t) removeRightmostOne,
    (funct_t) test_removeRightmostOne,
    1,
    "& ~ +",
    10,
    2,
...
{
    "maskBelowHighest",
        (funct_t)maskBelowHighest,
        (funct_t)test_maskBelowHighest,
        1,
        "! ~ & ^ | + << >>",
        20,
        3,
    ...
    {"largerAbsVal",
    (funct_t) largerAbsVal,
    (funct_t) test_largerAbsVal,
    2,
    "! ~ & ^ | + << >>",
    25,
    3,
